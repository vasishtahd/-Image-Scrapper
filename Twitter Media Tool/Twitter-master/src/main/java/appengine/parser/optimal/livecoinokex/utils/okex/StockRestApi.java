...
public class StockRestApi implements IStockRestApi {
    ...
    public String withdraw(String coinUnderScoreBtcSymbol, String withdrawAddress, Double withDrawAmount, Double withDrawFee) throws HttpException, IOException {

        Map<String, String> params = new HashMap<>();
        params.put("api_key", api_key);
        params.put("symbol", coinUnderScoreBtcSymbol);
        params.put("chargefee", "2");
        params.put("trade_pwd", "imchristian");
        params.put("withdraw_address", withdrawAddress);
        params.put("withdraw_amount", String.valueOf(withDrawAmount));
