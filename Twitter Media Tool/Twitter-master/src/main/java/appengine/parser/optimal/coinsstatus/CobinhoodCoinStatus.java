...
public class CobinhoodCoinStatus implements CoinsStatusUtil {
    ...
    public void fetch() {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("http://api.cobinhood.com/v1/market/currencies")
                    .get()
            ...
            JSONArray dataJsonArray = resultObject.getJSONArray("currencies");
            ...
            for (int i = 0; i < dataJsonArray.length(); i++) {
                ...
                try {
                    ...
                    if (!dataJsonObject.getBoolean("deposit_frozen") &&
                            !dataJsonObject.getBoolean("withdrawal_frozen")) {
                        isWalletActive = true;
    ...
    public CoinStatus toCoinStatus(Object... rawCoinInfo) {
        ...
        CoinStatus coinInfo = new CoinStatus(Market.COBINHOOD, coinName, label, isWalletActive, isListingActive);
        return coinInfo;
    }
}
